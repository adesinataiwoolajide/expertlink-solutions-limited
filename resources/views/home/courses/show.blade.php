                            ...
                            <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="fw-bold mb-0">₦{{ number_format($revenue,2) ?? 0.00 }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="fw-bold mb-0">{{ $totalNotes ?? 0 }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="fw-bold mb-0">{{ $totalAssignment ?? 0 }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="fw-bold mb-0">{{ $course->submissions->count() ?? 0 }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="fw-bold mb-0">{{ $totalStudent ?? 0 }} Students</h3>
                                    </div>
                                </div>
                            </div>
                        </div>

                        ...
                        <div class="col-lg-12">
                            <div class="header default-menu-style position-relative">
                                ...
                                <div class="header__logo">
                                    <a href="./">
                                        <img src="{{ asset('elsFront/images/logo/logo-dark.webp')}}" aria-label="Mitech Logo" width="160" height="48" class="img-fluid" alt="">
                                    </a>
                                </div>
                                    ...
                                    <div class="header-right-inner" id="hidden-icon-wrapper">
                                        ...
                                        <div class="language-menu">
                                            <ul>
                                                <li>
                                                    <a href="#" class="">
                                                        <img class="ls-flag" src="{{ asset('elsFront/images/flags/en.webp')}}" alt="en" title="English">
                                                    ...
                                                    <ul class="ls-sub-menu">
                                                        <li class="">
                                                            <a href="#" class="">
                                                                <img class="ls-flag" src="{{ asset('elsFront/images/flags/fr.webp')}}" alt="en" title="Français"><span class="wpml-ls-native">Français</span>
                                                            </a>
                                                        </li>
                                                        <li class="">
                                                            <a href="#" class="">
                                                                <img class="wpml-ls-flag" src="{{ asset('elsFront/images/flags/de.webp')}}" alt="de" title="Deutsch"><span class="wpml-ls-native">Deutsch</span>
                                                            </a>
                                                        </li>

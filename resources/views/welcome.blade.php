                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <a href="#" class="projects-wrap style-01 wow move-up">
                                        <div class="projects-image-box">
                                            <div class="projects-image">
                                                <img class="img-fluid" src="{{ asset('elsFront/images/projects/case-study-02-480x298.webp')}}" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <a href="#" class="projects-wrap style-01 wow move-up">
                                        <div class="projects-image-box">
                                            <div class="projects-image">
                                                <img class="img-fluid" src="{{ asset('elsFront/images/projects/case-study-03-480x298.webp')}}" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <a href="#" class="projects-wrap style-01 wow move-up">
                                        <div class="projects-image-box">
                                            <div class="projects-image">
                                                <img class="img-fluid" src="{{ asset('elsFront/images/projects/case-study-04-480x298.webp')}}" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="swiper-wrapper testimonial-slider__wrapper">
                                        ...
                                        <div class="testimonial-slider__single wow move-up">
                                            ...
                                            <div class="author-info">
                                                <div class="testimonial-slider__media">
                                                    <img src="{{ asset('elsFront/images/testimonial/mitech-testimonial-avata-04-70x70.webp')}}" class="img-fluid" alt="">
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-slider__single wow move-up">
                                            ...
                                            <div class="author-info">
                                                <div class="testimonial-slider__media">
                                                    <img src="{{ asset('elsFront/images/testimonial/mitech-testimonial-avata-02-70x70.webp')}}" class="img-fluid" alt="">
                                                </div>
                                                <div class="testimonial-slider__author">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-slider__single wow move-up">
                                            ...
                                            <div class="author-info">
                                                <div class="testimonial-slider__media">
                                                    <img src="{{ asset('elsFront/images/testimonial/mitech-testimonial-avata-01-70x70.webp')}}" class="img-fluid" alt="">
                                                </div>
                                                <div class="testimonial-slider__author">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-slider__single wow move-up">
                                            ...
                                            <div class="author-info">
                                                <div class="testimonial-slider__media">
                                                    <img src="{{ asset('elsFront/images/testimonial/mitech-testimonial-avata-03-70x70.webp')}}" class="img-fluid" alt="">
                                                </div>
                                                <div class="testimonial-slider__author">
                ...
                <div class="row">
                        ...
                        <div class="single-blog-item blog-grid">
                            ...
                            <div class="post-feature blog-thumbnail">
                                <a href="blog-post-layout-one.html">
                                    <img class="img-fluid" src="{{ asset('elsFront/images/blog/blog-03-370x230.webp')}}" alt="Blog Images">
                                </a>
                            </div>
                            <!-- Post Feature End -->
                    ...
                    <div class="col-lg-4 col-md-6 wow move-up">
                        ...
                        <div class="single-blog-item blog-grid">
                            ...
                            <div class="post-feature blog-thumbnail">
                                <a href="blog-post-layout-one.html">
                                    <img class="img-fluid" src="{{ asset('elsFront/images/blog/blog-02-370x230.webp')}}" alt="Blog Images">
                                </a>
                            </div>
                            <!-- Post Feature End -->

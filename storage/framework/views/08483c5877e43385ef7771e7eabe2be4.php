    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Please fill the below form to Create a Course Note for <?php echo e($course->course_name ?? ''); ?></h5>
            </div>
            <div class="card-body">
                <div class="row gx-3">
                    <form action="<?php echo e(route('note.store')); ?>" method="POST" enctype="multipart/form-data"><?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" class="form-control" name="topic" placeholder="Enter the Topic" value="<?php echo e(old('topic')); ?>" required>
...
<?php endif; ?>
                             ...
                             <?php $__currentLoopData = ['link_one', 'link_two', 'link_three', 'link_four']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mb-3 col-md-4">
                                    <label class="form-label">YouTube/Video Link <?php echo e($index + 1); ?>:</label>
                                    <input type="text" class="form-control" name="<?php echo e($link); ?>" value="<?php echo e(old($link) ?? "https://www.youtube.com/watch?v="); ?>">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea class="form-control summernote2" name="content" id="content" required><?php echo old('content') ?? "<p> Please enter the course contents here</p>"; ?></textarea>
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\expertlink_solutions\resources\views/home/notes/create.blade.php ENDPATH**/ ?>
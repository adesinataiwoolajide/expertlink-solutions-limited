        ...
        <?php if(count($myProgram) > 0): ?>
            <div class="d-flex flex-wrap justify-content-center gap-3 mb-5">
                ...
                <?php $__currentLoopData = $myProgram; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <button data-filter=".cat--<?php echo e($program->slug); ?>" class="btn btn-outline-secondary rounded-pill shadow-sm">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 mb-4 course-item cat--<?php echo e($course->programSlug); ?>">
                    <div class="card h-100 border-0 shadow-lg rounded-4 overflow-hidden hover-card">
                        ...
                        <div class="card-body d-flex flex-column p-4">
                            <h5 class="fw-bold text-dark mb-1"><?php echo e(Str::limit($course->course_name, 30)); ?></h5>
                            ...
                            <div class="mt-auto d-flex flex-wrap gap-2 mb-3">
                                <a href="<?php echo e(route('student.course.assignments', $course->slug)); ?>"
                                    class="badge bg-info text-white px-3 py-2 rounded-pill shadow-sm text-decoration-none"
                                    data-bs-toggle="tooltip" title="View your <?php echo e($course->student_assignments_count); ?> submitted assignments">
                                    📝 <?php echo e($course->student_assignments_count); ?> Assignments
                                </a>

                                <a href="<?php echo e(route('student.course.progress', $course->slug)); ?>"
                                    class="badge bg-success text-white px-3 py-2 rounded-pill shadow-sm text-decoration-none"
                                    data-bs-toggle="tooltip" title="Your overall progress on this course is <?php echo e($course->progressForStudent()); ?>%">
                                    📊 <?php echo e($course->progressForStudent()); ?>% Progress
                                </a>
                            </div>

                            <!-- Actions -->
                            <div class="mt-auto d-flex justify-content-between align-items-center">
                                <a href="<?php echo e(route('mycourse.note.index',$course->slug)); ?>" class="btn btn-sm btn-outline-primary rounded-pill px-3 shadow-sm">
                                    Start Learning
                                </a>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\expertlink_solutions\resources\views/home/courses/myCourses.blade.php ENDPATH**/ ?>
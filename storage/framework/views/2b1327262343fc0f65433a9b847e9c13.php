                            ...
                            <!-- Progress badges -->
                             <div class="mt-auto d-flex flex-wrap gap-2 mb-2">
                                ...
                                <a href="<?php echo e(route('student.course.assignments', $course->slug)); ?>"
                                    ...
                                    title="View your <?php echo e($course->student_assignments_count); ?> submitted assignments">
                                        📝 <?php echo e($course->student_assignments_count); ?> Assignments
                                </a>

                                <!-- Tasks badge -->
                                <a href="<?php echo e(route('student.course.tasks', $course->slug)); ?>"
                                    class="badge bg-success text-white px-3 py-2 rounded-pill shadow-sm text-decoration-none"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="View your <?php echo e($course->student_tasks_count); ?> completed tasks">
                                        ✅ <?php echo e($course->student_tasks_count); ?> Tasks
                                </a>
                                ...
                                <a href="<?php echo e(route('student.course.progress', $course->slug)); ?>"
                                    ...
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Your overall progress on this course is <?php echo e($course->progressForStudent()); ?>%">

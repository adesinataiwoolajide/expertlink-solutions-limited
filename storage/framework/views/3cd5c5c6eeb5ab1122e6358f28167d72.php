                                        ...
                                        <div class="swiper-slide brand-logo brand-logo--slider">
                                            <a href="#">
                                                <div class="brand-logo__image">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-01.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                                <div class="brand-logo__image-hover">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-01-hover.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="swiper-slide brand-logo brand-logo--slider">
                                            <a href="#">
                                                <div class="brand-logo__image">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-02.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                                <div class="brand-logo__image-hover">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-02-hover.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="swiper-slide brand-logo brand-logo--slider">
                                            <a href="#">
                                                <div class="brand-logo__image">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-03.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                                <div class="brand-logo__image-hover">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-03-hover.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="swiper-slide brand-logo brand-logo--slider">
                                            <a href="#">
                                                <div class="brand-logo__image">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-04.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                                <div class="brand-logo__image-hover">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-04-hover.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="swiper-slide brand-logo brand-logo--slider">
                                            <a href="#">
                                                <div class="brand-logo__image">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-05.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                                <div class="brand-logo__image-hover">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-05-hover.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="swiper-slide brand-logo brand-logo--slider">
                                            <a href="#">
                                                <div class="brand-logo__image">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-06.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                                <div class="brand-logo__image-hover">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-06-hover.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="swiper-slide brand-logo brand-logo--slider">
                                            <a href="#">
                                                <div class="brand-logo__image">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-07.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                                <div class="brand-logo__image-hover">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-07-hover.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="swiper-slide brand-logo brand-logo--slider">
                                            <a href="#">
                                                <div class="brand-logo__image">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-08.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                                <div class="brand-logo__image-hover">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-08-hover.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="swiper-slide brand-logo brand-logo--slider">
                                            <a href="#">
                                                <div class="brand-logo__image">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-09.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                                <div class="brand-logo__image-hover">
                                                    <img src="<?php echo e(asset('elsFront/images/brand/mitech-client-logo-09-hover.webp')); ?>" class="img-fluid" alt="">
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="modern-grid-image-box row row--30">
                                    ...
                                    <div class="single-item wow move-up col-lg-6 col-md-6 section-space--mt_60">
                                        <a href="cloud-managed-services" class="ht-box-images style-02">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="<?php echo e(asset('elsFront/images/icons/mitech-processing-service-image-02-80x83.webp')); ?>" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="single-item wow move-up col-lg-6 col-md-6 section-space--mt_60">
                                        <a href="it-security-compliance" class="ht-box-images style-02">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="<?php echo e(asset('elsFront/images/icons/mitech-processing-service-image-03-80x83.webp')); ?>" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="single-item wow move-up col-lg-6 col-md-6 section-space--mt_60">
                                        <a href="software-development" class="ht-box-images style-02">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="<?php echo e(asset('elsFront/images/icons/mitech-processing-service-image-04-80x83.webp')); ?>" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="single-item wow move-up col-lg-6 col-md-6 section-space--mt_60">
                                        <a href="it-consultancy" class="ht-box-images style-02">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="<?php echo e(asset('elsFront/images/icons/mitech-processing-service-image-06-80x83.webp')); ?>" alt="">
                                                </div>
                                                <div class="content">

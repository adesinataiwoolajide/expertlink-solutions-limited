                    ...
                    <table id="basicExample" class="table custom-table">
                        ...
                        <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('note.course.assignments',$assignment->noteSlug)); ?>" class="btn btn-info text-white">View</a>
                                    <a href="<?php echo e(route('submission.course.create',$assignment->slug)); ?>" class="btn btn-primary text-white">Submission</a>
                                </td>
                            </tr>

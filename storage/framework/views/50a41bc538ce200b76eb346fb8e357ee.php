    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <?php if(Auth::user()->hasAnyRole(['Administrator', 'Admin', 'Instructor']) && $totalNotes > 0): ?>
                    <a href="<?php echo e(route('mycourse.note.index', $course->slug)); ?>" class="btn btn-sm btn-info text-white">
                        Read Notes
                    </a>
                <?php endif; ?>
            </div>
                ...
                <div class="row g-4">
                        ...
                        <div class="col-xxl-3 col-sm-6">
                            <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="text-secondary fw-semibold">Total Revenue</h6>
                                        <h3 class="fw-bold mb-0">₦<?php echo e(number_format($revenue,2) ?? 0.00); ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php if(Auth::user()->hasAnyRole(['Administrator',"Admin", "Instructor"])): ?>
                        ...
                        <div class="col-xxl-2 col-sm-6">
                            <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="text-secondary fw-semibold">Total Course Notes</h6>
                                        <h3 class="fw-bold mb-0"><?php echo e($totalNotes ?? 0); ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-2 col-sm-6">
                            <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="text-secondary fw-semibold">Total Assignments</h6>
                                        <h3 class="fw-bold mb-0"><?php echo e($totalAssignment ?? 0); ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                                <div class="card-body d-flex align-items-center">
                                    <div class="icon-box-lg bg-gradient-success text-white rounded-3 me-3 d-flex align-items-center justify-content-center">
                                        <i class="ri-upload-line fs-2"></i>
                                    </div>
                                    <div>
                                        <h6 class="text-secondary fw-semibold">Total Submissions</h6>
                                        <h3 class="fw-bold mb-0"><?php echo e($course->submissions->count() ?? 0); ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-2 col-sm-6">
                            <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                                <div class="card-body d-flex align-items-center">
                                    <div class="icon-box-lg bg-gradient-danger text-white rounded-3 me-3 d-flex align-items-center justify-content-center">
                                        <i class="ri-team-line fs-2"></i>
                                    </div>
                                    <div>
                                        <h6 class="text-secondary fw-semibold">Total Students</h6>
                                        <h3 class="fw-bold mb-0"><?php echo e($totalStudent ?? 0); ?> Students</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if(Auth::user()->hasAnyRole(['Administrator', 'Admin'])): ?>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="<?php echo e(route('user.show',$user->slug)); ?>" class="dropdown-item text-success">

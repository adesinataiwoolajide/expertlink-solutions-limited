                ...
                <div class="card mb-3">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            <?php if(Auth::user()->hasAnyRole(['Instructor', 'Administrator'])): ?>
                                    ...
                                    <?php $__currentLoopData = ['link_one', 'link_two', 'link_three', 'link_four']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if(strtolower($youtubeLink) != 'https://www.youtube.com/watch?v=' && !empty($youtubeLink)): ?>
                                                <div class="col-md-3 mb-3">
                                                    <div class="card border border-<?php echo e($color); ?>">
                                                        <div class="card-body">
                                                            <h6 class="card-title text-<?php echo e($color); ?> mb-3">Video Link <?php echo e($index + 1); ?>:</h6>
                                                            <a href="<?php echo e($youtubeLink); ?>" target="_blank" class="d-flex align-items-center text-decoration-none mb-3">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor"
                                                                    class="bi bi-youtube me-2 text-<?php echo e($color); ?>" viewBox="0 0 16 16">
                                                                ...
                                                                <span class="text-<?php echo e($color); ?>">Watch <?php echo e($youtubeLink); ?></span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <?php else: ?>
                                            <div class="col-md-12 mb-3">
                                                <iframe width="100%" height="500" src="<?php echo e($youtubeLink ?? ''); ?>" frameborder="1" scrolling="auto"></iframe>
                                            </div>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

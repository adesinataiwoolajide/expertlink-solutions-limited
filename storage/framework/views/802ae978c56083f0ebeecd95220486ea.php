<?php $title =  "View Course Allocations"; $segments = Request::segments(); $number=1;  ?>
    ...
    <div class="app-hero-header d-flex align-items-center m-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(route('allocation.index')); ?>" title="View all <?php echo e($segments[1]); ?>">View all <?php echo e($segments[1]); ?></a></li>
                <li class="breadcrumb-item active" aria-current="page">View <?php echo e($segments[1]); ?> Details</li>
            </ol>
        </nav>
                            ...
                            <div class="tab-pane fade show active" id="vStep1" role="tabpanel" aria-labelledby="vStep1-tab">
                                <?php if(Auth::user()->hasAnyRole(['Administrator', 'Admin'])): ?>
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        ...
                                        <a href="<?php echo e(route('course.show', $course->slug)); ?>" class="btn btn-primary">
                            ...
                            <div class="tab-pane fade" id="vStep5" role="tabpanel" aria-labelledby="vStep5-tab">
                                <?php if(Auth::user()->hasAnyRole(['Administrator', 'Instructor'])): ?>
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        ...
                                        <?php if(Auth::user()->hasAnyRole(['Administrator', 'Admin', 'Instructor'])): ?>
                                            <a href="<?php echo e(route('note.create', [$course->slug, $allocation->slug])); ?>" class="btn btn-primary">
                            ...
                            <div class="tab-pane fade" id="vStepA1" role="tabpanel" aria-labelledby="vStepA1-tab">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-3">
                                        ...
                                        <p class="form-control-plaintext"><?php echo e(number_format($course->course_price)); ?></p>
                                    </div>

                                    <div class="mb-4 col-md-12">
                                        <label class="form-label fw-bold text-primary">Training Type:</label>
                                        <p class="form-control-plaintext">
                                            <?php $__currentLoopData = explode(',', $course->training_type); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\expertlink_solutions\resources\views/home/allocations/show.blade.php ENDPATH**/ ?>
        ...
        <div class="row g-4">
                ...
                <div class="col-xxl-2 col-sm-4 col-12">
                    <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div>
                                <h3 class="fw-bold mb-0 counter"><?php echo e(number_format($totalUsers)); ?></h3>
                ...
                <div class="col-xxl-2 col-sm-4 col-12">
                    <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div>
                                <h3 class="fw-bold mb-0 counter"><?php echo e(number_format($totalPayment)); ?></h3>
            ...
            <div class="col-xxl-2 col-sm-4 col-12">
                <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bold mb-0 counter"><?php echo e(number_format($totalPrograms)); ?></h3>
            ...
            <div class="col-xxl-2 col-sm-4 col-12">
                <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bold mb-0 counter"><?php echo e(number_format($totalCourses)); ?></h3>
            ...
            <div class="col-xxl-2 col-sm-4 col-12">
                <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bold mb-0 counter"><?php echo e(number_format($totalAllocations)); ?></h3>
            ...
            <div class="col-xxl-2 col-sm-4 col-12">
                <div class="card shadow-sm border-0 rounded-4 h-100 hover-card">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bold mb-0 counter"><?php echo e(number_format($totalInstructors)); ?></h3>
            ...
            <?php if(Auth::user()->hasAnyRole(['Administrator',"Admin"])): ?>
                ...
                <script>
                    ...
                    const chartData = {
                        labels: <?php echo json_encode($paymentSums->pluck('paymentProvider'), 15, 512) ?>,
                        datasets: [{
                            label: 'Total Revenue',
                            data: <?php echo json_encode($paymentSums->pluck('totalSum'), 15, 512) ?>,
                ...
                <div class="col-xxl-6 col-sm-12 col-12">
                    ...
                    <script>
                        ...
                        const programData = {
                            ...
                            labels: <?php echo json_encode($programRevenue->map(fn($p) => $p->program->program_name ?? $p->programSlug), 15, 512) ?>,
                            datasets: [{
                                label: 'Revenue',
                                data: <?php echo json_encode($programRevenue->pluck('totalSum'), 15, 512) ?>,
                                backgroundColor: [
                                    '#4e73df',
                                    '#1cc88a',
                                    '#36b9cc',
                ...
                <div class="col-xxl-12 col-sm-12 col-12">
                    ...
                    <script>
                        ...
                        const courseData = {
                            ...
                            labels: <?php echo json_encode($courseRevenue->map(fn($c) => $c->course->course_name ?? $c->courseSlug), 15, 512) ?>,
                            datasets: [{
                                label: 'Revenue',
                                data: <?php echo json_encode($courseRevenue->pluck('totalSum'), 15, 512) ?>,
                                backgroundColor: [
                                    '#4e73df',
                                    '#1cc88a',
                                    '#36b9cc',

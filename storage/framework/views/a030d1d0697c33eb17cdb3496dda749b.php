        ...
        <div class="card">
            <div class="card-header bg-light border-0 d-flex justify-content-between align-items-center py-3 px-4 shadow-sm">
                ...
                <div class="d-flex align-items-center gap-3">
                    <!-- View Courses Button -->
                    <a href="<?php echo e(route('course.index')); ?>" class="btn btn-sm btn-primary d-flex align-items-center">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end p-2 shadow" aria-labelledby="cartDropdown">
                                <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="d-flex justify-content-between align-items-center mb-2">
                                        <span class="text-truncate" style="max-width: 150px;"><?php echo e($item['course_name']); ?></span>
                                        <span class="badge bg-primary"><?php echo e($item['quantity']); ?></span>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <li><hr class="dropdown-divider"></li>
                                <li>
                                    <a href="<?php echo e(route('cart.view')); ?>" class="btn btn-sm btn-primary w-100">
                ...
                <div class="row gx-3">
                    <div class="col-lg-3 col-md-12 mb-lg-0 mb-4">
                                ...
                                <button type="button" class="nav-link active w-100 text-start" id="vStep1-tab"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <small><?php echo e($program->program_name); ?> details</small>
                                        </div>
                                    </div>
                                </button>
                            </li>
                        ...
                        <div class="mb-3 col-md-12">
                            <img src="<?php echo e(asset('program-banner/'. $program->banner )); ?>" class="img-fluid login-logo" style="width: auto; height: 200px;" alt="" />
                        </div>
                    </div>
                        ...
                        <div class="tab-content border rounded-2" id="verticalFormStepperContent">
                            ...
                            <div class="tab-pane fade show active" id="vStep1" role="tabpanel" aria-labelledby="vStep1-tab">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h6 class="text-primary"><?php echo e($program->program_name ?? ''); ?> Details</h6>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-md-12">
                                        <label class="form-label fw-bold">Program Name:</label>
                                        <p class="form-control-plaintext"><?php echo e($program->program_name); ?></p>
                                    </div>
                                    <div class="mb-3 col-md-12">
                                        <label class="form-label fw-bold">Program Description:</label>
                                        <p class="form-control-plaintext"><?php echo $program->description ?? 'NULL'; ?></p>
                                    </div>  
                                </div>
                            </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\expertlink_solutions\resources\views/home/courses/programCourse.blade.php ENDPATH**/ ?>
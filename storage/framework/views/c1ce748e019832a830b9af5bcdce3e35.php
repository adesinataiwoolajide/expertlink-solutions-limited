<nav id="sidebar" class="sidebar-wrapper">
    ...
    <div class="app-brand">
		<a href="<?php echo e(route('dashboard')); ?>">
			<img src="<?php echo e(asset('elsAdmin/images/els.png')); ?>" class="logo" alt="" style="width: ; height:;">
		</a>
    </div>
    <!-- App brand ends -->
				...
				<li class="treeview <?php echo e(request()->routeIs('user.*') ? 'active current-page' : ''); ?>">
					...
					<ul class="treeview-menu">
						<li class="<?php echo e(request()->routeIs('user.create') ? 'active' : ''); ?>">
							<a href="<?php echo e(route('user.create')); ?>">Create a User</a>
						</li>
						<li class="<?php echo e(request()->routeIs('user.index') ? 'active' : ''); ?>">
							<a href="<?php echo e(route('user.index')); ?>">View All Users</a>
						</li>
					</ul>
				</li>
				<?php endif; ?>

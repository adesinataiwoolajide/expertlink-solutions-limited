...
<?php $component->withAttributes([]); ?>
    ...
    <form action="<?php echo e(route('createAccount')); ?>" class="my-5" method="POST">
		...
		<div class="auth-box border border-dark" style="width: ;">
            ...
            <a class="mb-4 d-flex">
                <img src="<?php echo e(asset('elsAdmin/images/els.png')); ?>" class="img-fluid login-logo" style="width: 40%; float: center;" />
            </a>
...
<?php endif; ?>
    ...
    <input type="text" class="form-control" id="full_name" name="full_name" value="<?php echo e(old('full_name')); ?>" required autofocus autocomplete="name"
        placeholder="Enter your full name" />

                    ...
                    <div class="col-lg-12">
                        <div class="header position-relative">
                            ...
                            <div class="header__logo top-logo">
                                <a href="./">
                                    <img src="<?php echo e(asset('elsFront/images/logo/logo-dark.webp')); ?>" width="160" height="48" aria-label="Mitech Logo" class="img-fluid" alt="">
                                </a>
                            </div>
                        ...
                        <div class="row footer-widget-wrapper">
                            <div class="col-lg-4 col-md-6 col-sm-6 footer-widget">
                                <div class="footer-widget__logo mb-30">
                                    <img src="<?php echo e(asset('elsFront/images/logo/dark-logo-160x48.webp')); ?>" width="160" height="48" class="img-fluid" alt="">
                                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-6 col-8">
                                ...
                                <div class="logo">
                                    <a href="./">
                                        <img src="<?php echo e(asset('elsFront/images/logo/logo-dark.webp')); ?>" class="img-fluid" alt="">
                                    </a>
                                </div>
                            </div>

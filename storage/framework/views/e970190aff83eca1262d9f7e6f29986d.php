        ...
        <div class="card-body bg-light">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <?php if(Auth::user()->hasAnyRole(['Administrator',"Admin", "Instructor"])): ?>
                    <a href="<?php echo e(route('course.show',$course->slug)); ?>" class="btn btn-sm btn-info text-white">Course Details</a>
                <?php endif; ?>
                            ...
                            <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden note-card">
                                <div class="card-body d-flex flex-column p-4">
                                    ...
                                    <div class="mt-auto d-flex flex-wrap gap-2">
                                        <!-- Assignments badge -->
                                        <a href="<?php echo e(route('note.course.assignments', $note->slug)); ?>"
                                            class="badge bg-info text-white px-3 py-2 rounded-pill shadow-sm text-decoration-none"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="View your <?php echo e($note->assignments->count()); ?> submitted assignments">
                                                📝 <?php echo e($note->assignments->count()); ?> Assignments
                                        </a>

                                        <!-- Progress badge -->
                                        <a href="<?php echo e(route('note.course.progress', $note->slug)); ?>"
                                        ...
                                        <a href="<?php echo e(route('course.note.edit', $note->slug)); ?>"

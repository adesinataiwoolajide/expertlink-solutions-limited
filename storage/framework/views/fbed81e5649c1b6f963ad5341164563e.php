...
<?php $component->withAttributes([]); ?>
    ...
    <form action="<?php echo e(route('password.store')); ?>" class="my-5" method="POST">
		<?php echo csrf_field(); ?>
		...
		<div class="auth-box border border-dark">
			...
			<h5 class="fw-light mb-5 lh-2">
                <b>Hello <?php echo e($user->first_name. ' '. $user->last_name); ?>, Kindly fill the below form to update ypur password.</b>
            </h5>
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="email" name="email" value="<?php echo e($request->email); ?>" readonly autofocus autocomplete="email"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\expertlink_solutions\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>